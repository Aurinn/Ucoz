...
//В случае "краша" или подобных проблем/причин неотправленного текста, скрипт автоматически сохраняет текст
//на локальное хранилище, а при повторном открытии страницы встраивает его в поле для сообщения.
//Для каждой страницы сохраняется отдельно.
